...
public class LauncherActivity extends AppCompatActivity {
	...
	private static final String COMMITS_URL = "https://api.github.com/repos/Elinsrc/Client-Mod/commits/master";
	private static final String RUNS_URL = "https://api.github.com/repos/Elinsrc/Client-Mod/actions/runs?branch=master";
	private static final String APK_URL = "https://github.com/Elinsrc/Client-Mod/releases/download/continuous/client-mod.apk";
	...
	public void onCreate(Bundle savedInstanceBundle) {
		...
		aboutButton.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW)
				.setData(Uri.parse("https://github.com/Elinsrc/Client-Mod/"))));
