...
EXTERN const GLcharARB * ( APIENTRY *glGetString )(GLenum name);
...
EXTERN void ( APIENTRY *glGetCompressedTexImage)( GLenum target, GLint lod, const void* data );
...
EXTERN void ( APIENTRY *glVertexPointer)(GLint size, GLenum type, GLsizei stride, const void *ptr);
EXTERN void ( APIENTRY *glNormalPointer)(GLenum type, GLsizei stride, const void *ptr);
EXTERN void ( APIENTRY *glColorPointer)(GLint size, GLenum type, GLsizei stride, const void *ptr);
EXTERN void ( APIENTRY *glTexCoordPointer)(GLint size, GLenum type, GLsizei stride, const void *ptr);
...
EXTERN GLhandleARB (APIENTRY *glCreateShader)(GLenum shaderType);
...
EXTERN void (APIENTRY *glGetShaderSource)(GLuint shader, GLsizei bufSize, GLsizei *length, GLcharARB *source);
EXTERN void (APIENTRY *glShaderSource)(GLuint shader, GLsizei count, const GLcharARB *const *string, const GLint *length);
...
EXTERN GLhandleARB (APIENTRY *glCreateProgram)(void);
EXTERN void (APIENTRY *glDeleteProgram)(GLuint program);
EXTERN void (APIENTRY *glGetShaderInfoLog)(GLuint shader, GLsizei maxLength, GLsizei *length, GLcharARB *infoLog);
EXTERN void (APIENTRY *glGetProgramInfoLog)(GLuint program, GLsizei maxLength, GLsizei *length, GLcharARB *infoLog);
EXTERN void (APIENTRY *glGetActiveUniform)(GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLcharARB *name);
EXTERN GLint (APIENTRY *glGetUniformLocation)(GLuint program, const GLcharARB *name);
...
EXTERN void ( APIENTRY *glGetProgramiv)(GLenum target, GLenum pname, GLint *params);
...
EXTERN void ( APIENTRY *glGetProgramBinary)( GLuint program, GLsizei bufferSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary );
EXTERN void ( APIENTRY *glProgramBinary)(GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length);
EXTERN void ( APIENTRY *glProgramParameteri)(GLuint program, GLenum pname, GLint value);
EXTERN void ( APIENTRY *glTexImage3D)( GLenum target, GLint level, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels );
...
EXTERN void ( APIENTRY *glBindFragDataLocation)(GLuint programObj, GLuint index, const GLcharARB *name);
...
EXTERN void ( APIENTRY *glVertexAttrib4ubvARB)( GLuint index, const GLubyte *b );
...
EXTERN void ( APIENTRY * glSwapInterval )( int interval );
...
EXTERN GLvoid ( APIENTRY *glColorMaski)( GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a );
...
EXTERN void ( APIENTRY *glGenVertexArrays )( GLsizei n, const GLuint *arrays );
EXTERN GLboolean ( APIENTRY *glIsVertexArray )( GLuint array );

typedef void ( APIENTRY *glDebugProcARB)( GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLcharARB* message, GLvoid* userParam );
...
EXTERN void ( APIENTRY *glDebugMessageInsertARB)( GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const char* buf );
EXTERN void ( APIENTRY *glDebugMessageCallbackARB)( glDebugProcARB callback, void* userParam );
EXTERN GLuint ( APIENTRY *glGetDebugMessageLogARB)( GLuint count, GLsizei bufsize, GLenum* sources, GLenum* types, GLuint* ids, GLuint* severities, GLsizei* lengths, char* messageLog );

EXTERN void (APIENTRY *glGetObjectLabel)(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei *length, GLcharARB *label);
EXTERN void (APIENTRY *glGetObjectPtrLabel)(const void *ptr, GLsizei bufSize, GLsizei *length, GLcharARB *label);
EXTERN void (APIENTRY *glObjectLabel)(GLenum identifier, GLuint name, GLsizei length, const GLcharARB *label);
EXTERN void (APIENTRY *glObjectPtrLabel)(const void *ptr, GLsizei length, const GLcharARB *label);
EXTERN void (APIENTRY *glPopDebugGroup)(void);
EXTERN void (APIENTRY *glPushDebugGroup)(GLenum source, GLuint id, GLsizei length, const GLcharARB *message);

EXTERN void (APIENTRY *glAlphaToCoverageDitherControlNV)(GLenum mode);
