...
void EV_FireGauss( event_args_t *args )
{
	...
	while( flDamage > 10 && nMaxHits > 0 )
	{
		...
		if( pEntity->solid == SOLID_BSP )
		{
			...
			if( n < 0.5f ) // 60 degrees
			{
				...
				if ( CVAR_GET_FLOAT("cl_gauss_hits") )
				{
				...
				if ( CVAR_GET_FLOAT("cl_gauss_balls") )
				{
					gEngfuncs.pEfxAPI->R_Sprite_Trail( TE_SPRITETRAIL, tr.endpos, fwd, m_iBalls, 3, 0.1, gEngfuncs.pfnRandomFloat( 10.0f, 20.0f ) / 100.0f, 100, 255, 100 );
				}
	...
	//////////////////////////////////// WHAT TO DO HERE
							...
							if ( CVAR_GET_FLOAT("cl_gauss_balls") )
							{
								...
								gEngfuncs.pEfxAPI->R_Sprite_Trail( TE_SPRITETRAIL, beam_tr.endpos, fwd, m_iBalls, (int)( flDamage * 0.3f ), 0.1, gEngfuncs.pfnRandomFloat( 10.0f, 20.0f ) / 100.0f, 200, 255, 40 );
							}
				...
				else
				{
					if( m_fPrimaryFire )
					{
						...
						if ( CVAR_GET_FLOAT("cl_gauss_balls") )
						{
							vec3_t fwd;
							VectorAdd( tr.endpos, tr.plane.normal, fwd );
							gEngfuncs.pEfxAPI->R_Sprite_Trail( TE_SPRITETRAIL, tr.endpos, fwd, m_iBalls, 8, 0.6, gEngfuncs.pfnRandomFloat( 10.0f, 20.0f ) / 100.0f, 100, 255, 200 );
						}
					}
